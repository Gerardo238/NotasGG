...
function createNodeFetch() {
  ...
  const httpsAgent = new require$$2.Agent(agentOptions);
...
export { $fetch as $, br as b, checkNuxtCompatibility as c, fetchModules as f, getRegistryFromContent as g, qn as q };
