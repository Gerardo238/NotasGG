...
import { d as defineCommand, b as legacyRootDirArgs, c as cwdArgs, v as version } from '../shared/nuxi.CM8jcyGe.mjs';
import { p as pathKey, c as crossSpawn, o as onExit, i as is64bitSync, a as isWSL } from '../shared/nuxi.DsOlW5d4.mjs';
...
import { r as readPackageJSON } from '../shared/nuxi.8uLzFmy0.mjs';
import { s as splitByCase } from '../shared/nuxi.BjhZEm2-.mjs';
import { l as logger, v } from '../shared/nuxi.S8HN3O_c.mjs';
...
import { d as detectPackageManager } from '../shared/nuxi.DkoVccfL.mjs';
import 'node:crypto';
import 'node:module';
...
const makeError$1 = (xselError, fallbackError) => {
...
const xselWithFallback = async (argumentList, options) => {
	try {
		...
		try {
			...
			throw makeError$1(xselError, fallbackError);
		}
	}
};
...
const clipboard$3 = {
	async copy(options) {
		await tryWaylandWithFallback('wl-copy', textArgs, options, clipboard$4.copy);
	},
	copySync(options) {
		tryWaylandWithFallbackSync('wl-copy', textArgs, options, clipboard$4.copySync);
	},
	async paste(options) {
		return tryWaylandWithFallback('wl-paste', [...textArgs, '--no-newline'], options, clipboard$4.paste);
	},
	pasteSync(options) {
		return tryWaylandWithFallbackSync('wl-paste', [...textArgs, '--no-newline'], options, clipboard$4.pasteSync);
	},
};
