...
import { d as defineCommand, l as logLevelArgs, c as cwdArgs, r as runCommand } from '../shared/nuxi.CM8jcyGe.mjs';
import { R as R$2, l as logger, a as colors } from '../shared/nuxi.S8HN3O_c.mjs';
import 'node:tty';
import { $ as $fetch } from '../shared/nuxi.Gg4oZG1J.mjs';
import { f as findFile, r as readPackageJSON, w as writePackageJSON } from '../shared/nuxi.8uLzFmy0.mjs';
import { x as ve } from './main.mjs';
import addModuleCommand from './add2.mjs';
...
import require$$0, { promisify } from 'node:util';
...
import require$$36 from 'url';
import path from 'node:path';
import { i as installDependencies } from '../shared/nuxi.DkoVccfL.mjs';
...
`),"normalizeLinefeeds"),DA=[],oA=new Uint8Array([13,10]);IA=0;let aA=false;for(const[sA,NA]of K)if(typeof NA=="string"){const wA=V.encode(kA+`; name="${bA(gA(sA))}"\r
\r
${gA(NA)}\r
